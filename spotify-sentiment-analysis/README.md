...
```bash
export GENIUS_API_TOKEN="your_token_here"    # bash / zsh
```

```powershell
$env:GENIUS_API_TOKEN = "your_token_here"    # PowerShell
```

The token that was originally committed has been revoked and is no longer valid.
